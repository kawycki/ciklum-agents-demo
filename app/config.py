"""Configuration, read from the environment with defaults."""
from __future__ import annotations

import os
from pathlib import Path

# No .resolve(): it is disallowed inside Temporal's workflow sandbox.
...
SANDBOX_TIMEOUT_S = int(os.environ.get("SANDBOX_TIMEOUT_S", "30"))          # host wall-clock kill
SANDBOX_GUEST_TIMEOUT_S = int(os.environ.get("SANDBOX_GUEST_TIMEOUT_S", "20"))  # in-guest payload kill
